...
Local evidence: Python 3.11, NumPy 1.26.4, 87 complete tests; 24 marked mathematical cases with 14 analytic, 9 differential, 11 metamorphic, 9 causality, and 15 stress memberships; strict Ruff and Pyright; four notebooks parsed; deterministic Lift 2 source-contract rebuild passed.
